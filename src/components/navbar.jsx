...
{/* -------------------------navbar---------------------------------------------- */}
          ...
          <section className="prenavbar">
            <div>
              <img src={olx} alt="My Image" className="navlogo" />
            </div>
            <div className="preNav_elements">
              <FontAwesomeIcon icon={faCar} className="icon" /> Motors
            </div>
            <div className="preNav_elements">
            
              <FontAwesomeIcon icon={faBuilding} className="icon" /> property
            </div>
          </section>
{/* -------------------------Navbar--------------------------------------------- */}
          ...
          <section className="navbar1">
            <section>
              <img src={olxlogo} alt="My Image" className="navlogomain" />
            </section>
